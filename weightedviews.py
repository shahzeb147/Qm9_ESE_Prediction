...
def qm9filetowvmats(alist, speciesmap, carbonbased=False, viewlength=None):
    """
    Convert a list of atoms to np.arrays of weights and views for the QM9 dataset.
...
def load_qm9_data(all_molecules, speciesmap, setNatoms=None, setNviews=None, carbonbased=False, verbose=1):
    species = set()
    ...
    varrays = []
    for mol in all_molecules:
        w, v = qm9filetowvmats(mol, speciesmap, carbonbased, Natoms)
        warrays.append(w)
        varrays.append(v)
