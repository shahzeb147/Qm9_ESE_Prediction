...
def process_all_files_to_list(directory, max_files=50000):
    all_molecules = []
...
# Process up to 50,000 files and extract data into structured format
all_molecules = process_all_files_to_list(directory_path, max_files=50000)
...
print(all_molecules[10] if all_molecules else "No molecules processed.")
